                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($items as $item)
                                <tr>
                                    <td>
                                        <img src="{{ Storage::url($item['product']['thumbnail_url']) }}" width="80"
                                            alt="تصویر محصول">
                                    </td>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-danger btn-sm js-show-cart">
                                            حذف از سبد خرید
                                        </button>
                                    </td>
                                    <input type="hidden" name="items[{{ $item['product']['id'] }}][quantity]"
                                        value="{{ $item['quantity'] }}">
                                    <input type="hidden" name="items[{{ $item['product']['id'] }}][unit_price]"
